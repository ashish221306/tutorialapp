...
var PostComponent = /** @class */ (function () {
    ...
    PostComponent.prototype.loadAllPost = function () {
        var _this = this;
    ...
    PostComponent.prototype.setFormState = function () {
    ...
    PostComponent.prototype.handleFileInput = function (file) {
        var _this = this;
        this.fileToUpload = file.item(0);
        var reader = new FileReader();
        reader.onload = function (event) {
            _this.postImage = event.target.result;
        };
...
var EmployeeserviceService = /** @class */ (function () {
    ...
    EmployeeserviceService.prototype.createemployee = function (employee) {
        return this.http.post(this.url + 'insertdata', employee);
    };
    EmployeeserviceService.prototype.loginemployee = function (loginEmployee) {
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(employeeservice, formbuilder, router) {
    ...
    LoginComponent.prototype.setFormState = function () {
    ...
    LoginComponent.prototype.login = function (loginEmployee) {
        var _this = this;
        this.employeeservice.loginemployee(loginEmployee).subscribe(function (user) {
            debugger;
            var succ = user;
            if (succ) {
                ...
                _this.Error = true;
                _this.massage = "User ID/Password Wrong";
            }
        });
    };
...
var RegistrationComponent = /** @class */ (function () {
    function RegistrationComponent(formbuilder, employeeservice) {
        this.formbuilder = formbuilder;
        this.employeeservice = employeeservice;
        this.datasaved = false;
    }
    ...
    RegistrationComponent.prototype.setFormState = function () {
        this.regForm = this.formbuilder.group({
    ...
    RegistrationComponent.prototype.onSubmit = function () {
        var employee = this.regForm.value;
        this.createemployee(employee);
        this.regForm.reset();
    };
    RegistrationComponent.prototype.createemployee = function (employee) {
        var _this = this;
        this.employeeservice.createemployee(employee).subscribe(function () {
            _this.datasaved = true;
            _this.massage = "User Created";
            _this.regForm.reset();
        });
    };
...
var CourseCategoriesComponent = /** @class */ (function () {
    function CourseCategoriesComponent() {
    }
...
var CourseFeaturedComponent = /** @class */ (function () {
    function CourseFeaturedComponent() {
    }
    CourseFeaturedComponent.prototype.ngOnInit = function () {
    };
    ...
    return CourseFeaturedComponent;
}());
...
var CourseRecentComponent = /** @class */ (function () {
    function CourseRecentComponent() {
    }
    CourseRecentComponent.prototype.ngOnInit = function () {
    };
